...
import { jsMathSnippets } from './jsMathSnippets';
...
const JsMathViewer = () => {
  ...
  const [colors] = useState(() => jsMathSnippets.map(() => getRandomColor()));

  const filteredSnippets = jsMathSnippets.filter(snippet =>
