...
import { jsArraySnippets } from './jsArraySnippets';
...
const JsArrayViewer = () => {
  ...
  const [colors] = useState(() => jsArraySnippets.map(() => getRandomColor()));

  const filteredSnippets = jsArraySnippets.filter(snippet =>
